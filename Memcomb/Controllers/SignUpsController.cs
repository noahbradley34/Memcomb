...
namespace Memcomb.Controllers
{
    public class SignUpsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,ReleaseDate,Genre,Price")] SignUp signUp)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,ReleaseDate,Genre,Price")] SignUp signUp)
        {
            if (ModelState.IsValid)
            {
